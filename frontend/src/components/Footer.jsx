...
export default function Footer() {
  ...
  const hideFooterOn = [
    ...
    '/jobAlerts',
    '/Settings',
    '/dashboard', // If you have a dashboard parent route
    '/JobCard',   // If you have profile pages
  ];
  ...
  // Also hide on exact matches for common dashboard routes
  const exactPaths = ['/overview', '/applied-jobs', '/job-alerts', '/settings'];
  const shouldHideExact = exactPaths.includes(location.pathname);
  
  // Combine both checks
  if (shouldHideFooter || shouldHideExact) {
